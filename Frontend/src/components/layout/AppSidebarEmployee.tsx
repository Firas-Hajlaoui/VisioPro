...
const menuItems = {
  ...
  rh: {
    ...
    icon: Users,
    items: [
      { icon: Clock, label: "Temps de travail", href: "/employee/rh/temps" },
      
      { icon: Calendar, label: "Congés", href: "/employee/rh/conges" },
      { icon: KeyRound, label: "Autorisations", href: "/employee/rh/autorisations" },
      { icon: Banknote, label: "Note de frais", href: "/employee/rh/frais" }
    ],
  },
  departments: [
    { icon: FileText, label: "Fiches d'Intervention", href: "/employee/fiche-intervention" },
    { icon: FolderKanban, label: "Projets", href: "/employee/projets" },
  ],
  docs: [
